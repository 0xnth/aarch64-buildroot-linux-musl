aarch64--musl--bleeding-edge-2020.02-2
...
For those who would like to reproduce the toolchain, you can just follow these steps:
    ...
    curl http://toolchains.bootlin.com/downloads/releases/toolchains/aarch64/build_fragments/aarch64--musl--bleeding-edge-2020.02-2.defconfig > .config
    make olddefconfig
    make
